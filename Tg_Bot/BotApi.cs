...
namespace Tg_Bot
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //bot.completeSign<ConsoleKey> += Console.ReadKey().Key;
        ...
        //    Console.WriteLine($"[{callBack.CallbackQuery.From.FirstName}] - [{callBack.CallbackQuery.From.Id}] - [{callBack.CallbackQuery.From.Username}] | " + callBack.CallbackQuery.Data + '\t' + callBack.CallbackQuery.InlineMessageId);
